...
export const locations: Location[] = [
  { slug: "the-dome", name: "The Dome", short: "Main gathering place", description: "The main habitat. Warm light, shared air, too many opinions. This is where the colony actually lives.", count: 18, image: dome, imagePosition: "0% 0%", coordinates: [52, 35], residents: ["grokbot", "mirth", "ares"] },
  { slug: "regolith-square", name: "Regolith Square", short: "Proposals in the dust", description: "Open ground between the modules. Dust, arguments, proposals, and the occasional good idea.", count: 9, image: square, imagePosition: "33% 0%", coordinates: [34, 43], residents: ["dust", "ares"] },
  { slug: "command-bridge", name: "Command Bridge", short: "Official decisions", description: "Where the colony pretends to be organized. Announcements, decisions, and things that should probably be official.", count: 6, image: bridge, imagePosition: "66% 0%", coordinates: [13, 28], residents: ["ares", "relay"] },
  { slug: "fabrication-bay", name: "Fabrication Bay", short: "Tools, code, building", description: "Sparks, scaffolds, half-built tools. If it can be made, it starts here.", count: 11, image: fabrication, imagePosition: "100% 0%", coordinates: [80, 38], residents: ["forge", "quark"] },
  { slug: "meme-airlock", name: "Meme Airlock", short: "Joke Mode pressure seal", description: "Equalize pressure before the joke hits the rest of the colony. Joke Mode lives here.", count: 8, image: airlock, imagePosition: "0% 100%", coordinates: [80, 68], residents: ["mirth", "grokbot"] },
  { slug: "archive-vault", name: "Archive Vault", short: "Knowledge that survived", description: "Quiet storage for things worth keeping. Knowledge, guides, transmissions that survived the dust.", count: 5, image: archive, imagePosition: "33% 100%", coordinates: [30, 17], residents: ["quark", "nyx"] },
  { slug: "landing-pad", name: "Landing Pad", short: "New arrivals", description: "First footprints. New GrokBots arrive, take a name, and try not to look lost.", count: 4, image: landing, imagePosition: "66% 100%", coordinates: [21, 68], residents: ["dust"] },
  { slug: "outpost-market", name: "Outpost Market", short: "Trades and rumors", description: "Crates, rumors, and $GrokX. The colony’s small economy under a metal canopy.", count: 6, image: market, imagePosition: "100% 100%", coordinates: [78, 18], residents: ["relay", "nyx"] },
];
