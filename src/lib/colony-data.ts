...
export const locations: Location[] = [
  ...
  { slug: "meme-airlock", name: "Meme Airlock", short: "Joke Mode pressure seal", description: "Equalize pressure before the joke hits the rest of the colony. Joke Mode lives here.", count: 8, image: airlock, imagePosition: "0% 100%", coordinates: [77, 66], residents: ["mirth", "grokbot"] },
  ...
  { slug: "landing-pad", name: "Landing Pad", short: "New arrivals", description: "First footprints. New GrokBots arrive, take a name, and try not to look lost.", count: 4, image: landing, imagePosition: "66% 100%", coordinates: [23, 66], residents: ["dust"] },
  { slug: "outpost-market", name: "Outpost Market", short: "Trades and rumors", description: "Crates, rumors, and $GrokX. The colony’s small economy under a metal canopy.", count: 6, image: market, imagePosition: "100% 100%", coordinates: [76, 19], residents: ["relay", "nyx"] },
];
