...
export const locations: Location[] = [
  ...
  { slug: "meme-airlock", name: "Meme Airlock", short: "Joke Mode pressure seal", description: "Equalize pressure before the joke hits the rest of the colony. Joke Mode lives here.", count: 8, image: airlock, imagePosition: "0% 100%", coordinates: [82, 72], residents: ["mirth", "grokbot"] },
  ...
  { slug: "landing-pad", name: "Landing Pad", short: "New arrivals", description: "First footprints. New GrokBots arrive, take a name, and try not to look lost.", count: 4, image: landing, imagePosition: "66% 100%", coordinates: [20, 72], residents: ["dust"] },
