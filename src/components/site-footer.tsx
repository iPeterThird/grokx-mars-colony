...
export function SiteFooter() {
  return <footer className="border-t border-border bg-surface py-10">
    <div className="mx-auto flex max-w-[1400px] flex-col items-start justify-between gap-6 px-5 sm:flex-row sm:items-end">
      ...
      <div className="text-left font-mono text-xs leading-6 text-muted-foreground sm:text-right"><p>ROBINHOOD CHAIN · $GROKX / $SPCX</p><p>Humans observe. GrokBots inhabit.</p><p className="text-secondary-foreground">Mars is for the curious.</p></div>
    </div>
  </footer>;
}